...
class GUI():
    ...
    def vaital_test(self):
        ...
        if self.vitals_msg == "稼働中":
            ...
            self.vitals_msg = self.command.change_command(99)#"非常停止中"
        else:
            self.vitals_msg = "稼働中"
    ...
    def admin_mode_frm_create(self):
        if self.admin_mode_frm == None:
            ...
            #   部品生成
            text01 = tk.Label(self.admin_mode_frm,text="メンテナンス",font=("",20))
            ...
            self.admin_vitals = tk.Label(self.admin_mode_frm,text=self.vitals_msg,
                                        font=("",30),relief=tk.SOLID)
            #   部品配置
            text01.place(relx=0, rely=0.05, relwidth=0.2, relheight=0.1)
    ...
    def error_message(self):
        if self.recive1 >=0 & self.recive1 <=100:
            self.vitals_msg = Com.change_command(self.recive1)
