...
class GUI():
    ...
    def main_frm_create(self):
        ...
        self.main_vitals.place(relx=0.75, rely=0.1, relwidth=0.15, relheight=0.1)
    ...
    def vision_up(self):
        ...
        w_size = int(img1.width/2)
        h_size = int(img1.height/2)
        self.ttk_img = None
        ...
        cvs.place(relx=0.1,rely=0.02,anchor=tk.NW)
    ...
    def show_size_log_graph(self):
        ...
        self.canvas.get_tk_widget().place(relx=0.2, rely=0.2)
        #   動作確認用
        ut=time.time()
        print(ut)
        if(self.flag_02 == 1):
    ...
    def count_log(self):
        ...
        #   現在の表示内容を更新
        display_label = tk.Label(self.count_frm, text="本日の記録",font=("",27))
        display_label.place(relx=0.02,rely=0.02, relwidth=0.12, relheight=0.12)
        ...
        self.tree.place(width=1600,height=300,relx=0.15,rely=0.02,anchor=tk.NW)
    ...
    def count_log_7_days(self):
        ...
        display_label = tk.Label(self.count_frm, text="七日間の記録",font=("",27))
        display_label.place(relx=0.02,rely=0.02, relwidth=0.12, relheight=0.12)
        ...
        #   ﾌﾗｸﾞが立っていたら
        if(self.flag_03 == 1):
            self.cansel_id = self.rootform.after(5000,self.count_log_7_days)
