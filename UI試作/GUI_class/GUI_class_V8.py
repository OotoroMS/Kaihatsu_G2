...
class GUI():
    ...
    def admin_mode_frm_create(self):
        if self.admin_mode_frm == None:
            ...
            #   部品生成
            text1 = tk.Label(self.admin_mode_frm,text="メンテナンス",font=("",40))
            buttonM1 = tk.Button(self.admin_mode_frm,text="メンテナンス1",font=("",20))
            buttonM2 = tk.Button(self.admin_mode_frm,text="メンテナンス2",font=("",20))
            buttonM3 = tk.Button(self.admin_mode_frm,text="メンテナンス3",font=("",20))
            buttonM4 = tk.Button(self.admin_mode_frm,text="メンテナンス4",font=("",20))
            buttonM5 = tk.Button(self.admin_mode_frm,text="メンテナンス5",font=("",20))
            buttonM6 = tk.Button(self.admin_mode_frm,text="メンテナンス6",font=("",20))
            buttonM7 = tk.Button(self.admin_mode_frm,text="メンテナンス7",font=("",20))
            ...
            self.admin_vitals = tk.Label(self.admin_mode_frm,text=self.vitals_msg,
                                        font=("",30),relief=tk.SOLID)
            #   部品配置
            text1.place(relx=0.05, rely=0.05, relwidth=0.2, relheight=0.1)
    ...
    def count_log(self):
        ...
        #   現在の表示内容を更新
        self.display_label = tk.Label(self.count_frm, text="本日の記録",font=("",45))
