...
class PassFrame(BaseFrame):
    def __init__(self, screen, font=None):
        ...
        self.buttons = {
            ...
            Button(self.screen, 660,  570, 180, 180, "GUI_main_test\\image\\button\\pic24.png", self.num_4),
            Button(self.screen, 850,  570, 180, 180, "GUI_main_test\\image\\button\\pic25.png", self.num_5),
            Button(self.screen, 1040, 570, 180, 180, "GUI_main_test\\image\\button\\pic26.png", self.num_6),
