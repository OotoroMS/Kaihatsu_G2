...
class Test04Frame(BaseFrame):
    def __init__(self, screen, font=None):
        ...
        self.buttons = {
            Button(self.screen, 250, 510, 600, 280, "GUI_main_test\\image\\button\\pic59.png", self.try15),#上下シリンダ上昇
            Button(self.screen, 1000, 510, 600, 280, "GUI_main_test\\image\\button\\pic60.png", self.try16),#下降
