...
db = SQLCommunication()
db.db_query_execution("testdb_option.db", delete_table)
db.db_query_execution("testdb_option.db", create_table_query)

db.db_query_execution("testdb_option.db",set_password_query)
db.db_list_display
print("end")