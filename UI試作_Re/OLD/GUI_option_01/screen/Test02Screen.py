...
class Test02Frame(BaseFrame):
    def __init__(self, screen, font=None):
        ...
        self.buttons = {
            Button(self.screen, 200, 400, 650, 320,BUTTONFILEPATH + "pic45.png", self.try06),#ソレノイド前進
            Button(self.screen, 1000, 400, 650, 320,BUTTONFILEPATH + "pic46.png", self.try07),#ステッピングモータ回転
