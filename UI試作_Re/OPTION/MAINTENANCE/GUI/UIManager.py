...
from CONSTANTS.serial_result    import *
# 定数(GUI)
from GUI.constants.UIManager_constant   import *
from GUI.constants.screen_name          import *
from GUI.constants.popup_name           import *
# マネージャー
from GUI.managers.OperatingManager  import OperatingManager
from GUI.managers.ScreenManager     import ScreenManager
from GUI.managers.PopupManager      import PopupManager
