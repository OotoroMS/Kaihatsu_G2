...
#   暗転処理
def brackout_screen(screen : pygame.Surface, image, draw_func):
...
#   明転処理
def lightchenge_screen(screen : pygame.Surface, image : pygame.Surface, draw_func):
    #   オーバーレイ生成
...
#   暗いオーバーレイを消す
def _erase_overlay(screen : pygame.Surface, overlay : pygame.Surface):
    overlay.set_alpha(255)
    screen.blit(overlay, (0, 0))
    _update_screen(100)

#   暗転
def _brackout(screen : pygame.Surface, image: pygame.Surface, frame : int, overlay: pygame.Surface, draw_func):
    darken_alpha = 255 * frame // DARKEN_DURATION
...
#   明転
def _lightchenge(screen : pygame.Surface, image: pygame.Surface, frame : int, overlay : pygame.Surface, draw_func):
