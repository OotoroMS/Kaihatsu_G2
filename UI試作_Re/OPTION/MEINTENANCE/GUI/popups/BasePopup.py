...
from MEINTENANCE.GUI.constants.popup_configs.base_config    import *
# 部品
from MEINTENANCE.GUI.parts.Button           import *
from MEINTENANCE.GUI.parts.Picture          import *
from MEINTENANCE.GUI.parts.CaluclatePopup   import *
...
class BasePopup:
    ...
    # 押下時のイベント処理
    def event_button_down(self, event : pygame.event.Event):
        result = None
        nomarl = False
